...
$('#organs-btn-next').addClass('nr_first_hide').attr('disabled',true);

$('#organs-btn-prev').on('click', function(){
    $('#organs-btn-next').removeClass('nr_first_hide').attr('disabled',false);
    var nextImageNo = imgFirstno;
    nextImageNo++;

    if(nextImageNo === imgLastno){
      $('#organs-btn-prev').addClass('nr_first_hide').attr('disabled',true);
      $('#organs-btn-next').removeClass('nr_first_hide').attr('disabled',false);
    }else{
      $(".imageContainer").removeClass('show').addClass('hideimageContainer');
      $("#im_" + nextImageNo).removeClass('hideimageContainer').addClass('show');
    }

    imgFirstno++;
});

$('#organs-btn-next').on('click', function(){
    $('#organs-btn-prev').removeClass('nr_first_hide').attr('disabled',false);
    var nextImageNo = imgFirstno;
    nextImageNo--;
    ...
    // if(imgLastno == cnt){
    //     $("#im_" + imgFirstno).addClass('show');
    //     $(this).addClass('nr_last_hide')
    // }else{
    //     $(this).removeClass('nr_last_hide');
    //     cnt++;
    // }
